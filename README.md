...
1. **Clone the Repository**
   ```
   git clone https://github.com/pnnl-predictive-phenomics/csc040-gem.git
   cd csc040-gem
   ```
...
This project is licensed under the [Apache 2.0](https://github.com/pnnl-predictive-phenomics/csc040-gem/blob/main/LICENSE) license. See the `LICENSE` file for details.
